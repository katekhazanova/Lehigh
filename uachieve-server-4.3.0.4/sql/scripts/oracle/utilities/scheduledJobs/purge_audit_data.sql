...
/* and all audit reports that are over x days old.              */
/*                                                              */
/* Number of days to keep audit data is determined by variable  */
/* keepDays, which can be set to any integer value.             */
/* Default is 30.                                               */
/*                                                              */
/* For best results, schedule this job to run at least daily    */
/* during low audit demand times.                               */
/*==============================================================*/
...
declare
    ...
    deleteCount int := 0;
    keepDate date := (sysdate - keepDays);
