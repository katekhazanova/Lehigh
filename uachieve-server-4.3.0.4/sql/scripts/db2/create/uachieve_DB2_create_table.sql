...
/* Script name:    uachieve_DB2_create_table.sql                  */
...
/*                                                                */
/* Highlights: 	u.achieve Server 4.3	                     	  */
...
create table job_queue_run (
   ...
   dptitle2             varchar(65)           null,
   webtitle             varchar(50)           null,
   detail_seq_no        numeric(18)           null default 0,
   ...
   incltop_text			varchar(2000) 		  null,  
   host_name 			varchar(255) 	  	  null, 
   host_ip				varchar(255) 		  null,
   uach_dir				varchar(255) 	 	  null,
   comkey				char(5) 			  null,
...
/* ==== Index:  jobq_out_idx                                       */
create index jobq_out_idx on JOB_QUEUE_OUT (int_seq_no ASC)
;
