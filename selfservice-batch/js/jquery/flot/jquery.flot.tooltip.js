...
(function ($) {
    ...
    FlotTooltip.prototype.init = function (plot) {
	    ...
	    plot.showTooltip = function (target, position) {
	        ...
	        $tip.html(tipText);
	        if ( position == null ) {
	        	plot.setTooltipPosition({ x: plot.getOptions().accessibility.position.pageX, y: plot.getOptions().accessibility.position.pageY });
	        } else {
    ...
    FlotTooltip.prototype.stringFormat = function (content, item, plot) {
        ...
        // if no value customization
       	content = content.replace(xPatternWithoutPrecision, parseFloat(x.toPrecision(12)));
       	content = content.replace(yPatternWithoutPrecision, parseFloat(y.toPrecision(12)));
