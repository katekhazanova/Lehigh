...
<input type="hidden" id="mobilePageGroup" value="plannedCourses"/>
		...
		<form role="form" method="post" action="../plannedcourse/create.html" id="row" class="focusable">	
	...
	<#elseif validationErrors?? && validationErrors>
		...
		<!--<#if errors??>${errors}</#if>-->
			...
			<div class="form-group col-md-3">
				...
				<input id="comp_id.crsNum" type="text" class="form-control" value="${courseValue!''}" name="comp_id.crsNum" maxlength="15">
			</div>
			...
			<div class="form-group">
				...
				<a href="<@h.url href='/plannedcourse/list.html'/>" title="Return" alt="Return" role="button" class="btn btn-default"> Return </a>
			</div>
		</form>
			...
			<@p.masterView plannedCourseListPageContext />
